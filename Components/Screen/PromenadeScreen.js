...
import { Footer, FooterTab, Content, Spinner, Card,  CardItem, Thumbnail, Left, Body, Right, Button, Icon } from 'native-base';
...
class PromenadeScreen extends React.Component {
  ...
  jointClick = async () => {
    if (this.props.user.token) {
      ...
      if (this.state.joint == true) {
        Alert.alert("Promenade ajoutée")
        ...
        Alert.alert("A la prochaine fois..?");
